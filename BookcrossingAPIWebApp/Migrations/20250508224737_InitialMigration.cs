        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookId = table.Column<int>(type: "int", nullable: false),
                    CurrentHolderId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCopies_Users_CurrentHolderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookRoutes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookRoutes_BookCopies_BookCopyId",
                        column: x => x.BookCopyId,
                        principalTable: "BookCopies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookRoutes_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCopies_CurrentHolderId",
                table: "BookCopies",
                column: "CurrentHolderId");

            migrationBuilder.CreateIndex(
                name: "IX_BookRoutes_BookCopyId",
                table: "BookRoutes",
                column: "BookCopyId");

            migrationBuilder.CreateIndex(
                name: "IX_BookRoutes_LocationId",
                table: "BookRoutes",
                column: "LocationId");
